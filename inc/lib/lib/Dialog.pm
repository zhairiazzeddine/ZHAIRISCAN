...
sub scansArgs {
  ...
  ."$c[5] --setCookie   $c[10] | Cookie file\n"
  ."$c[5] --saveCookie  $c[10] | Cookies output file\n"
...
sub shosearchadvise {
  print $c[4]."[!]$c[10] To learn how to use search filters type \'zhairiscan --shodan --filters\'\n";
}
...
sub sho_menu {
  ...
  print $c[4]."  [!] $c[10]To set proxy and browser random: \'zhairiscan --help\'\n";
  print $c[4]."  [!] $c[10]About filters: zhairiscan --shodan --apikey <apikey> --filters\n";
  print $c[4]."  [!] $c[10]To search exploits use: --bugtraq \n";
  print $c[4]."  [!] $c[10]To avoid typing your apikey in each process configure it in the\n      configuration panel: \'zhairiscan --config\' then \'set apikey <your_apikey>\'\n";
