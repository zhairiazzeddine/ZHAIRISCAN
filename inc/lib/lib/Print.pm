...
sub no_args {
  if (-e "/usr/bin/zhairiscan") {
    print $c[11]."[!] $OTHERS[5]:$c[5] zhairiscan$c[11] [$c[5]options$c[11]] or $c[5]zhairiscan$c[11] [$c[5]--help$c[11]|$c[5]-h$c[11]|$c[5]-?$c[11]] or $c[5]zhairiscan$c[11] [$c[5]--interactive$c[11]]\n";
  }else{
...
## SCAN FINISHED
sub Conclure {
  my ($limit, $ifend, $isscan, $output, $zhairiscans, $targets) = @_;
  separator();
  separaBlocks();
  my $np = $isscan ? $zhairiscans : $targets;
